...
public class Terrain extends JPanel{
	...
	/**
	 * Retourne la taille du taupes.terrain
	 * @return la taille du taupes.terrain
	 */
	...
	public void poserTaupe(int x, int y, Taupe taupe) {
		if (!estTas(x,y) && estTaupe(x,y)==0) terrain[x][y].poserTaupe(taupe);
	 ...
	 * @param y ordonnée
	 */
	public void setLibre(int x, int y) { terrain[x][y].vider(); }
